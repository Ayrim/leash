...
%w( home users user_sessions password_resets materialize.min authentication editSettings fullcalendar dog wallpost messaging images picture).each do |controller|
