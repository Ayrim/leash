...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
						...
						if ("scroll" === C) {
							...
							for (var K in q) {
								...
								if (g(f).isSVG || "tween" === P || v.Names.prefixCheck(P)[1] !== !1 || v.Normalizations.registered[P] !== d) {
									...
									h._cacheValues && F && F[K] ? (O === d && (O = F[K].endValue + F[K].unitType), Q = g(f).rootPropertyValueCache[P]) : v.Hooks.registered[K] ? O === d ? (Q = v.getPropertyValue(f, P), O = v.getPropertyValue(f, K, Q)) : Q = v.Hooks.templates[P][1] : O === d && (O = v.getPropertyValue(f, K));
									var R,
									S,
									T,
									U = !1;
	...
	j($, Z, {
		...
		directionTest : function (a) {
			...
			f = a.deltaX,
			g = a.deltaY;
			return e & b.direction || (b.direction & Ha ? (e = 0 === f ? Ca : 0 > f ? Da : Ea, c = f != this.pX, d = Math.abs(a.deltaX)) : (e = 0 === g ? Ca : 0 > g ? Fa : Ga, c = g != this.pY, d = Math.abs(a.deltaY))),
			a.direction = e,
	...
	a.fn.collapsible = function (b) {
		...
		this.each(function () {
			...
			g.on("click.collapse", "> li > .collapsible-header", function (g) {
				...
				b.accordion || "accordion" === i || void 0 === i ? c(j) : (d(j), h.hasClass("active") && d(h))
			});
			...
			function e(b) {
				...
				if (h.belowOrigin === !0 && (n = f), k + j.innerWidth() > a(window).width() ? m = "right" : k - j.innerWidth() + g.innerWidth() < 0 && (m = "left"), l + j.innerHeight() > e)
					if (l + f - j.innerHeight() < 0) {
						...
						n || (n += f), n -= j.innerHeight();
				if ("left" === m)
					c = h.gutter, leftPosition = g.position().left + c;
				else if ("right" === m) {
			...
			if (!a(this).hasClass("initialized")) {
				...
				i.on("click", function () {
					...
					for (; null !== d && !a(d).is(document); ) {
						var n = a(d);
						"visible" !== n.css("overflow") && (n.css("overflow", "visible"), c = void 0 === c ? n : c.add(n)),
						d = d.parentNode
					}
					i.css({
						position : "absolute",
					...
					var pic_real_width = $(i)[0].naturalWidth, 
					pic_real_height = $(i)[0].naturalHeight;
					var q = 0,
					r = l / j,
					s = m / k,
					t = 0,
					...
					i.hasClass("responsive-img") ? i.velocity({
						...
						complete : function () {
							i.css({
								...
								height : (u > pic_real_height) ? pic_real_height : u,
								width : (t > pic_real_width) ? pic_real_width : t,
								left : a(document).scrollLeft() + j / 2 - i.parent(".material-placeholder").offset().left - ((t > pic_real_width) ? pic_real_width : t) / 2,
								top : a(document).scrollTop() + k / 2 - i.parent(".material-placeholder").offset().top - ((u > pic_real_height) ? pic_real_height : u) / 2
							}, {
								duration : g,
								queue : !1,
								easing : "easeOutQuad",
	...
	var b = {
		init : function (b) {
			...
			this.each(function () {
				...
				f = c.find("li.tab a"),
				g = c.width(),
				h = Math.max(g, c[0].scrollWidth) / f.length,
				i = 0;
				...
				c.on("click", "a", function (k) {
					...
					if (!a(this).attr("target")) {
						...
						i = f.index(a(this)),
						0 > i && (i = 0),
						void 0 !== e && (e.show(), "function" == typeof b.onShow && b.onShow.call(this, e)),
	...
	var b = {
		init : function (b) {
			...
			a(this).each(function () {
				...
				a("body").append(f),
				"left" == b.edge ? (e.css("left", -1 * (b.menuWidth + 10)), f.css({
						left : 0
...
(jQuery), function (a) {
	...
	a.scrollSpy = function (b, d) {
		...
		return i || (f.on("scroll", l), f.on("resize", l), i = !0),
		setTimeout(l, 0),
...
(jQuery), function (a) {
	a(document).ready(function () {
		...
		a(document).on("input mousedown touchstart", g, function (b) {
			...
			"input" !== b.type && (f = void 0 === b.pageX || null === b.pageX ? b.originalEvent.touches[0].pageX - a(this).offset().left : b.pageX - a(this).offset().left, 0 > f ? f = 0 : f > d && (f = d), c.addClass("active").css("left", f)),
			c.find(".value").html(a(this).val())
		}),
			...
			if (!d.hasClass("browser-default")) {
					...
					a(this).click(function (g) {
						if (!a(this).hasClass("disabled") && !a(this).hasClass("optgroup")) {
							...
							e ? (a('input[type="checkbox"]', this).prop("checked", function (a, b) {
									return !b
								}), h = c(k, a(this).index(), d), q.trigger("focus")) : (i.find("li").removeClass("active"), a(this).toggleClass("active"), q.val(a(this).text())),
				...
				s = function (b) {
					...
					if (13 != b.which || i.is(":visible")) {
						...
						38 == b.which && (g = i.find("li.selected").prev("li:not(.disabled)")[0], g && activateOption(i, g)),
						setTimeout(function () {
							r = []
						}, 1e3)
					}
		...
		init : function (b) {
			...
			this.each(function () {
				...
				function d(a) {
					...
					k != a && (e = j.eq(k), $caption = e.find(".caption"), e.removeClass("active"), e.velocity({
							opacity : 0
						}, {
				...
				b.indicators && (f = a('<ul class="indicators"></ul>'), j.each(function (c) {
						...
						f.append(e)
					}), h.append(f), f = h.find("ul.indicators").find("li.indicator-item")),
				e ? e.show() : (j.first().addClass("active").velocity({
						...
						queue : !1,
						easing : "easeOutQuad"
					}), k = 0, e = j.eq(k), b.indicators && f.eq(k).addClass("active")),
		...
		"data" === d ? this.$el.data("chips") : "options" === d ? this.$el.data("options") : (this.$el.data("options", a.extend({}, c, d)), this.init = function () {
			...
			e.$el.each(function () {
				...
				if (!c.data("initialized")) {
					...
					(!d.data || !d.data instanceof Array) && (d.data = []),
					c.data("chips", d.data),
					c.data("index", b),
					c.data("initialized", !0),
					c.hasClass(e.SELS.CHIPS) || c.addClass("chips"),
					e.chips(c),
					b++
				}
			})
				...
				if (!a(c.target).is("input, textarea")) {
					...
					if (f.length)
						if (8 === c.which || 46 === c.which) {
							...
							e.deleteChip(i, d, g);
							var j = null;
							h > d + 1 ? j = d : (d === h || d + 1 === h) && (j = h - 1),
							0 > j && (j = null),
							null !== j && e.selectChip(i, j, g),
							...
							if (d = f.index() + 1, a(b.CHIP).removeClass("selected"), d > h)
			...
			e.$document.on("focusin", b.CHIPS + " " + b.INPUT, function (c) {
				a(c.target).closest(b.CHIPS).addClass("focus"),
				a(b.CHIP).removeClass("selected")
			}),
			...
			e.$document.on("keydown", b.CHIPS + " " + b.INPUT, function (c) {
				...
				return 32 === c.which ? (c.preventDefault(), e.addChip(g, {
						tag : d.val()
			...
			e.$document.on("click", b.CHIPS + " " + b.DELETE, function (c) {
				...
				g = d.closest(b.CHIP);
				c.stopPropagation(),
				e.deleteChip(f.data("index"), g.index(), f),
				f.find("input").focus()
			})
			...
			b += '<input class="input" placeholder="">',
			a.html(b),
			e.setPlaceholder(a)
		}, this.renderChip = function (a) {
			if (a.tag) {
				var b = '<div class="chip">' + a.tag;
				return a.image && (b += ' <img src="' + a.image + '"> '),
				b += '<i class="material-icons close">close</i>',
				b += "</div>"
			}
			...
			if (e.isValid(d, c)) {
				...
				d.data("chips").push(c),
				a(f).insertBefore(d.find("input")),
				d.trigger("chip.add", c),
				e.setPlaceholder(d)
			}
		}, this.deleteChip = function (a, b, c) {
			var d = c.data("chips")[b];
			c.find(".chip").eq(b).remove(),
			c.data("chips").splice(b, 1),
			c.trigger("chip.delete", d),
			e.setPlaceholder(c)
...
(jQuery), function (a) {
	var b = {
		init : function (b) {
			...
			this.each(function () {
				function c() {
					"undefined" != typeof window.ontouchstart && (F[0].addEventListener("touchstart", k), F[0].addEventListener("touchmove", l), F[0].addEventListener("touchend", m)),
				...
				function l(a) {
					...
					f;
					if (q)
						if (b = d(a), y = e(a), c = t - b, f = Math.abs(u - y), 30 > f && !E)
							(c > 2 || -2 > c) && (D = !0, t = b, g(o + c));
						else {
							if (D)
				...
				return F.hasClass("initialized") ? !0 : (b.full_width && (b.dist = 0, imageHeight = F.find(".carousel-item img").first().load(function () {
						...
						void 0 === b && (b = 1),
						w = o + r * b,
						o !== w && (v = w - o, B = Date.now(), requestAnimationFrame(i))
